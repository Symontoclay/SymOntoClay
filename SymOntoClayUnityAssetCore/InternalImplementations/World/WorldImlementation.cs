...
namespace SymOntoClay.UnityAsset.Core.InternalImplementations.World
{
    public class WorldImlementation: IWorld
    {
        ...
        /// <inheritdoc/>
        public string InsertPublicFact(IMonitorLogger logger, string text) => _worldCore.InsertPublicFact(logger, text);

        /// <inheritdoc/>
        public string InsertPublicFact(IMonitorLogger logger, RuleInstance fact) => _worldCore.InsertPublicFact(logger, fact);

        /// <inheritdoc/>
        public void RemovePublicFact(IMonitorLogger logger, string id) => _worldCore.RemovePublicFact(logger, id);

        /// <inheritdoc/>
        public void PushSoundFact(float power, string text) => _worldCore.PushSoundFact(power, text);

        /// <inheritdoc/>
        public void PushSoundFact(float power, RuleInstance fact) => _worldCore.PushSoundFact(power, fact);

        /// <inheritdoc/>
        public IStandardFactsBuilder StandardFactsBuilder => _worldCore.StandardFactsBuilder;

        /// <inheritdoc/>
        public void AddCategory(IMonitorLogger logger, string category) => _worldCore.AddCategory(logger, category);

        /// <inheritdoc/>
        public void AddCategories(IMonitorLogger logger, List<string> categories) => _worldCore.AddCategories(logger, categories);

        /// <inheritdoc/>
        public void RemoveCategory(IMonitorLogger logger, string category) => _worldCore.RemoveCategory(logger, category);

        /// <inheritdoc/>
        public void RemoveCategories(IMonitorLogger logger, List<string> categories) => _worldCore.RemoveCategories(logger, categories);
