...
{
    public class KeyWorldComponentClassCardWithPath : IDataCard, IDataCardWithHeader, IDataCardWithPath, IObjectToString
    {
        /// <inheritdoc/>
        public KindOfDataCard KindOfDataCard => KindOfDataCard.KeyWorldComponentClassCardWithPath;
