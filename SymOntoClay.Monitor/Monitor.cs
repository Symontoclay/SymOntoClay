        ...
        public Monitor(MonitorSettings monitorSettings)
        {
            ...
            if (_features == null)
            {
                _features = new MonitorFeatures
                {
                    ...
                    EnableDoTriggerSearch = false,
                    EnableEndDoTriggerSearch = false,
                    EnableSetConditionalTrigger = false,
                    EnableResetConditionalTrigger = false,
                    EnableRunSetExprOfConditionalTrigger = false,
                    EnableEndRunSetExprOfConditionalTrigger = false,
                    EnableRunResetExprOfConditionalTrigger = false,
                    EnableEndRunResetExprOfConditionalTrigger = false,
                    EnableOutput = true,
                    EnableTrace = true,
                    EnableDebug = true,
                    EnableInfo = true,
