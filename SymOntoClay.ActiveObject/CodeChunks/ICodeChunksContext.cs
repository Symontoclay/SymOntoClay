...
namespace SymOntoClay.ActiveObject.CodeChunks
{
    public interface ICodeChunksContext : IBaseCodeChunksContext
    {
        ...
        void CreateAsyncCall<MethodResult>(string chunkId, Func<IAsyncMethodResponse<MethodResult>> preHandler, Action<IAsyncCallCodeChunkWithoutResultForMethodWithResultAndSelfReference<MethodResult>, MethodResult> postHandler);
    }
    ...
    public interface ICodeChunksContext<T> : IBaseCodeChunksContext
    {
        ...
        void CreateAsyncCall<MethodResult>(string chunkId, Func<T, IAsyncMethodResponse<MethodResult>> preHandler, Action<IAsyncCallCodeChunkWithoutResultForMethodWithResultAndSelfReference<T, MethodResult>, T, MethodResult> postHandler);
    }
    ...
    public interface ICodeChunksContext<T1, T2> : IBaseCodeChunksContext
    {
        ...
        void CreateAsyncCall<MethodResult>(string chunkId, Func<T1, T2, IAsyncMethodResponse<MethodResult>> preHandler, Action<IAsyncCallCodeChunkWithoutResultForMethodWithResultAndSelfReference<T1, T2, MethodResult>, T1, T2, MethodResult> postHandler);
    }
    ...
    public interface ICodeChunksContext<T1, T2, T3> : IBaseCodeChunksContext
    {
        ...
        void CreateAsyncCall<MethodResult>(string chunkId, Func<T1, T2, T3, IAsyncMethodResponse<MethodResult>> preHandler, Action<IAsyncCallCodeChunkWithoutResultForMethodWithResultAndSelfReference<T1, T2, T3, MethodResult>, T1, T2, T3, MethodResult> postHandler);
    }
}
