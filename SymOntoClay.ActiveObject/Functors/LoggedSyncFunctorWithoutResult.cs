...
{
    public class LoggedSyncFunctorWithoutResult: SyncFunctorWithoutResult<IMonitorLogger>
    {
    ...
    public class LoggedSyncFunctorWithoutResult<T> : SyncFunctorWithoutResult<IMonitorLogger, T>
    {
    ...
    public class LoggedSyncFunctorWithoutResult<T1, T2> : SyncFunctorWithoutResult<IMonitorLogger, T1, T2>
    {
    ...
    public class LoggedSyncFunctorWithoutResult<T1, T2, T3> : SyncFunctorWithoutResult<IMonitorLogger, T1, T2, T3>
    {
