    ...
    public class SentenceNodeOfSemanticAnalyzer : BaseNodeOfSemanticAnalyzer
    {
        ...
        public ResultOfNodeOfSemanticAnalyzer Run()
        {
            ...
            if (_sentence.VocativePhrase != null)
            {
                ...
                var vocativeNode = new NounPhraseNodeOfSemanticAnalyzer(Context, _sentence, _sentence.VocativePhrase.AsNounPhrase);
            ...
            if (subject != null)
            {
                var subjectNode = new NounPhraseNodeOfSemanticAnalyzer(Context, _sentence, subject);
            ...
            if (rootVerb != null)
            {
                var verbNode = new VerbPhraseNodeOfSemanticAnalyzer(Context, _sentence, rootVerb);
